...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        # self.add_class("object", 1, "MR192")
        self.add_class("object", 1, "MR192")
        # self.add_class("object", 2, "MR197")
        # self.add_class("object", 3, "MR235")
        # self.add_class("object", 4, "MR244")
        ...
        annotations1 = json.load(open(os.path.join(dataset_dir,"demo.json")))
        # print(annotations1)
        ...
        for a in annotations:
            ...
            # key = tuple(name_dict)
            name_dict = {"MR192" : 1}
            # name_dict = {"MR192" : 1, "MR197" : 2, "MR235" : 3, "MR244" : 4}
...
def train(model):
    ...
    dataset_train.load_custom("/content/drive/MyDrive/MASK_RCNN/dataset/", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content/drive/MyDrive/MASK_RCNN/dataset/", "val")
    dataset_val.prepare()
